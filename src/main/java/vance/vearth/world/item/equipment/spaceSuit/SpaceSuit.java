...
public record SpaceSuit(Holder<TrimMaterial> material, Holder<SuitDesign> design) implements TooltipProvider {
    public static final Codec<SpaceSuit> CODEC = RecordCodecBuilder.create((i) -> i.group(
            TrimMaterial.CODEC.fieldOf("material").forGetter(SpaceSuit::material),
            SuitDesign.CODEC.fieldOf("design").forGetter(SpaceSuit::design)
    ).apply(i, SpaceSuit::new));
    ...
    static {
        STREAM_CODEC = StreamCodec.composite(TrimMaterial.STREAM_CODEC, SpaceSuit::material, SuitDesign.STREAM_CODEC, SpaceSuit::design, SpaceSuit::new);
