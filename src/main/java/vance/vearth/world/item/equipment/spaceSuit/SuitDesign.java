...
public record SuitDesign(Identifier assetId, Component description, boolean decal) {
    public static final Codec<SuitDesign> DIRECT_CODEC = RecordCodecBuilder.create((i) -> i.group(
            Identifier.CODEC.fieldOf("asset_id").forGetter(SuitDesign::assetId),
            ComponentSerialization.CODEC.fieldOf("description").forGetter(SuitDesign::description),
            ExtraCodecs.optionalAlwaysPresentFieldOf(Codec.BOOL, "decal", false).forGetter(SuitDesign::decal)
    ).apply(i, SuitDesign::new));
    ...
    static {
        ...
        CODEC = RegistryCodecs.holder(ModRegistries.SUIT_DESIGN, DIRECT_CODEC);
